...
if ( (Tipo_Q3 ~= 'P') & (Tipo_Q3 ~='P')); error('Elegir R o P para Tipo_Q3'); end;
...
% Eslabón 1:
  theta1=q1 ; d1= 0; a1= L1; alpha1= -PI/2;
% Eslabón 2:
  theta2= q2+PI/2; d2=0 ; a2= L2; alpha2= PI/2;
% Eslabón 3:
...
% Inercias
  Jm1= 0.0038749; Jm2=0.00317704; Jm3=0.00388975; % kg.m2
% Coeficientes de fricción viscosa
  Bm1= 0.000233579; Bm2= 0.000200092; Bm3= 0.000181928; % N.m / (rad/s)
% Factores de reducción
  R1= 20; R2= 25; R3= 25; % Si no hay reductoras
