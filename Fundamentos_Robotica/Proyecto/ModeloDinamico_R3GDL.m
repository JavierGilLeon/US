...
Ma = [32.798*q3 - 1.2321*cos(2.0*q2) - 16.399*sin(2.0*q2) - 32.798*q3*cos(2.0*q2) - 32.798*q3*sin(2.0*q2) - 32.798*q3^2*cos(2.0*q2) + 32.798*q3^2 + 163.85, 32.798*cos(q2) + 40.998*sin(q2) + 65.596*q3*cos(q2), 65.596*sin(q2);
